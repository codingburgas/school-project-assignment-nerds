...
if (NOT QT_NO_CREATE_TARGETS AND Qt6SpatialAudio_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6SpatialAudioExtraProperties.cmake"
        OPTIONAL)
    ...
    foreach(_module_dep ${_Qt6SpatialAudio_MODULE_DEPENDENCIES})
        ...
        list(APPEND Qt6SpatialAudio${_private_suffix}_INCLUDE_DIRS
             ${Qt6${_module_dep}_INCLUDE_DIRS})
        list(APPEND Qt6SpatialAudio${_private_suffix}_PRIVATE_INCLUDE_DIRS
             ${Qt6${_module_dep}_PRIVATE_INCLUDE_DIRS})
        if(_private_suffix)
            list(APPEND Qt6SpatialAudio_PRIVATE_INCLUDE_DIRS
                ${Qt6${_module_dep}_PRIVATE_INCLUDE_DIRS})
        endif()
        list(APPEND Qt6SpatialAudio${_private_suffix}_DEFINITIONS
             ${Qt6${_module_dep}_DEFINITIONS})
        list(APPEND Qt6SpatialAudio${_private_suffix}_COMPILE_DEFINITIONS
