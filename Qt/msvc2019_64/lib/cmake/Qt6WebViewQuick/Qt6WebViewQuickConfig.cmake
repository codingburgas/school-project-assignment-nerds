...
if (NOT QT_NO_CREATE_TARGETS AND Qt6WebViewQuick_FOUND)
    ...
    foreach(_module_dep ${_Qt6WebViewQuick_MODULE_DEPENDENCIES})
        ...
        list(APPEND Qt6WebViewQuick${_private_suffix}_INCLUDE_DIRS
             ${Qt6${_module_dep}_INCLUDE_DIRS})
        list(APPEND Qt6WebViewQuick${_private_suffix}_PRIVATE_INCLUDE_DIRS
             ${Qt6${_module_dep}_PRIVATE_INCLUDE_DIRS})
        if(_private_suffix)
            list(APPEND Qt6WebViewQuick_PRIVATE_INCLUDE_DIRS
                ${Qt6${_module_dep}_PRIVATE_INCLUDE_DIRS})
        endif()
        list(APPEND Qt6WebViewQuick${_private_suffix}_DEFINITIONS
             ${Qt6${_module_dep}_DEFINITIONS})
        list(APPEND Qt6WebViewQuick${_private_suffix}_COMPILE_DEFINITIONS
